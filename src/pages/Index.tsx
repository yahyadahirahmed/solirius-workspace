...
//           {/* Chapter 5: Success and Discovery */}
//           {currentChapter >= 4 && (
//             <StoryChapter variant="interactive">
//               <div className="text-center mb-6">
//                 <h2 className="text-2xl font-bold text-foreground mb-4">Chapter 5: Discovery Made</h2>
...
//                     He could see her email address and current project details.
//                   </p>
//                   <p>
//                     With a deep breath, Alex sent an email explaining his project and asking 
...
//                   <div>
//                     <h3 className="text-2xl font-bold text-foreground mb-2">Expert Found!</h3>
//                     <p className="text-foreground/80">You've successfully found the expertise you needed</p>
//                   </div>
...
//                     became a story of discovery, collaboration, and confidence. The Staff Repository didn't just help him 
//                     find expertise—it helped him build relationships.
//                   </p>
//                   <p className="text-sm opacity-90">
//                     Within a week, Alex had not only completed his business case with Sarah's mentorship but had also reached out to 
//                     three other colleagues who became valuable collaborators on future projects. He went from feeling 
